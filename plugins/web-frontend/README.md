...
Frontend skills for Vue 3, WCAG 2.2 AA accessibility, and Core Web Vitals performance.
...
| [web-accessibility](skills/web-accessibility/SKILL.md) | Comprehensive web accessibility standards based on WCAG 2.2 AA, with 38+ anti-patterns, legal enforcement context (EAA, ADA Title II), WAI-ARIA patterns, and framework-specific fixes for modern web frameworks and libraries. |
